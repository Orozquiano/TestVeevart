...
def Jugar():
    ...
    while player <25:
        ...
        if player <= 25: #miramos si el numero sobrepaso al tablero si es asi jugador queda en la misma posicion y volvemos a lanzar el dado
            ...
            print("Sobre pasaste al tablero quedas en la misma posicion")
            player = NAnterior
